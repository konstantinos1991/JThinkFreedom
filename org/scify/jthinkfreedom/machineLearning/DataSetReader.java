...
/**
 * 
 * @author konstantinos This class will read all the images and using the
 *         ImageProcessor class we will extract features from the images that we
 *         will use in the machine learning. The features of all the images will
 *         be written to a file that will be later converted to Weka file
 *         format.
 */
