 ...
 * @author Konstantinos
 * 
 *         This class can read an image, transform it to a binary image(black
 *         and white) and save it to to disk It also extracts geometric
 *         properties from the image as these will be used as features when
...
//		System.loadLibrary(Core.NATIVE_LIBRARY_NAME);
	...
	/**
	 * converts an IplImage object to binary
	 * and stores the pixels to a 2D array
	 * 
